...
TOINSTALL="tmux emacs git libreoffice-core libreoffice-writer libreoffice-calc libreoffice-impress mg rbenv ruby-build kupfer curl libncurses5-dev gcc libssl-dev libxml2-dev haskell-stack guile-2.0 guile-2.0-libs guile-2.0-dev tk xfwm4-themes autoconf automake autogen libtool cpufrequtils xdotool gnome-terminal nodejs redshift-gtk zim midori chromium-browser xclip hplip gnupg gnupg-agent pinentry-curses libsdl2-dev libsdl2-image-dev libsdl2-mixer-dev libsdl2-ttf-dev gimp xosview flac gstreamer1.0-plugins-bad virtualbox virtualbox-qt virtualbox-guest-additions-iso vde2"
