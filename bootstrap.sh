...
TOINSTALL="tmux emacs git libreoffice-core libreoffice-writer libreoffice-calc libreoffice-impress mg rbenv ruby-build kupfer curl libncurses5-dev gcc libssl-dev libxml2-dev haskell-stack guile-2.0 tk xfwm4-themes autoconf automake libtool cpufrequtils xdotool gnome-terminal nodejs redshift-gtk zim midori chromium-browser"
